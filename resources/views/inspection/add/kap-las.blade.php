<form action={{ route('inspection.store') }} method="POST" enctype="multipart/form-data">
  ...
  <div class="mb-3">
    <label class="form-label">Apakah kaca hitam dalam keadaan baik?</label>
  ...
  <div class="mb-3">
    <label class="form-label">Apakah kaca bening dalam keadaan baik?</label>
    <div class="form-check d-flex align-items-center">
  ...
  <div class="mb-3">
    <label class="form-label">Apakah kancing berfungsi dengan baik?</label>
    <div class="form-check d-flex align-items-center">
